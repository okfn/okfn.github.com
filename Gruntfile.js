...
var projectimages = require('./img/projectimages.json');
...
module.exports = function(grunt) {
  ...
  grunt.registerTask('projectimg', 'generate json list of project images', function(arg) {
    ...
    // saves output as img/projectimages.json
    ...
    fs.writeFileSync("img/projectimages.json", JSON.stringify(imageurls)); //write to file
  });
